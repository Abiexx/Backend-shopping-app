...
public class Application {
    ...
    CommandLineRunner runner(UserService userService, ProductService productService) {
        return args -> {
            ...
            userService.addUser(new UsernamePassDto("abi", "123"));
            userService.addUser(new UsernamePassDto("milkias", "123"));

            userService.addRoleToUser("admin", "ADMIN");
            userService.addRoleToUser("buyer", "BUYER");
            userService.addRoleToUser("seller", "SELLER");
            userService.addRoleToUser("abi", "BUYER");
            userService.addRoleToUser("milkias", "SELLER");
            ...
            productService.saveProduct(new Product(null, "MacBook Pro", 2000, "This is MacBook Pro - 16 inch", false, "https://shopping-cart-product-images.s3.amazonaws.com/img/macBookPro14.jpg", null), 3);
